...
//-----------------------------------------------------------------------------
/**
 * This class creates a JDialog with calendar details. User can set/select
 * any date from this which can be populated 
 * in DateTextField. 
...
class JDayChooser extends JPanel implements ActionListener, KeyListener, FocusListener
{
    ...
    private static final Color SELECTED_COLOR = new Color(110, 110, 110);
  //-----------------------------------------------------------------------------
    public JDayChooser()
    {
  ...
  //-----------------------------------------------------------------------------
    public void setDay(int iDay)
    {
        ...
        for(int i=7; i<49; i++)
        {
            ...
            selectedDay.setBackground(RED_COLOR);
            break;
        }
