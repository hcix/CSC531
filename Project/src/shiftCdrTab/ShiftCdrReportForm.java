...
//-----------------------------------------------------------------------------	
public class ShiftCdrReportForm extends JDialog {
private static final long serialVersionUID = 1L;
	JButton[] buttons;
	ShiftCdrReport report;
	PDFView pdfv;
//-----------------------------------------------------------------------------	
	public ShiftCdrReportForm(JFrame parent){
...
//-----------------------------------------------------------------------------	
	public ShiftCdrReportForm(JFrame parent, String reportFileName){
...
//-----------------------------------------------------------------------------	
	public void closeAndSave() {
		...
		ArrayList<FieldAndVal> formFields = (ArrayList<FieldAndVal>) pdfv.getAllFormFields(); 
		putInfoIntoReport(formFields);
		
		report.saveToFileSystem();
